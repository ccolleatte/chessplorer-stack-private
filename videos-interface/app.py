...
def list_auteurs():
    ...
    return videos/render_template('auteurs.html', auteurs=auteurs, page=page, total=total, limit=limit)
...
def edit_auteur(id):
    ...
    return videos/render_template('edit_auteur.html', auteur=auteur)
...
def list_videos():
    ...
    return videos/render_template('videos.html', videos=videos, sources=sources, selected_source=source_id)
...
def zoom_video(id):
    ...
    return videos/render_template('zoom_video.html', video=video, similar=similar)
